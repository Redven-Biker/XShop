    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Add a product</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <form action="ajouter-produit-post.php" method="post">
                <h5 id="text-add-produit">Name of the product</h5>
    <input type="text" class="form-control" name="nom" placeholder="">
        <div class="space-input"></div>
                <h5 id="text-add-produit">Link of the pictures</h5>
    <input type="text" class="form-control" name="img" placeholder="">
        <div class="space-input"></div>
                <h5 id="text-add-produit">Price</h5>
    <input type="text" class="form-control" name="prix" placeholder="">
        <div class="space-input"></div>
                <h5 id="text-add-produit">Category</h5>
<select class="form-control" name="categorie">
';
include("../inc/config.php");
// Get contents of the lspd table
$reponse = $bdd->query('SELECT * FROM categories ORDER BY id DESC');

// Display each entry one by one
while ($data = $reponse->fetch()) {
?>
  <option class="select" value="<?php echo $data['nom']; ?>"><?php echo $data['nom']; ?></option>
                                                <?php
    }
