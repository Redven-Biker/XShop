...
include("../inc/config.php");
// Get contents of the lspd table
$reponse = $bdd->query('SELECT * FROM commandes ORDER BY id DESC');

// Display each entry one by one
while ($data = $reponse->fetch()) {
?>
  <div class="box">
    <div class="box-info"><b>Product :</b> <?php echo $data['produit']; ?></div>
    <div class="box-info"><b>Name :</b> <?php echo $data['nom']; ?></div>
    <div class="box-info"><b>Paypal Email :</b> <?php echo $data['email_paypal']; ?></div>
    <div class="box-info"><b>Discord :</b> <?php echo $data['discord']; ?></div>
    <div class="box-info"><b>Date :</b> <?php echo $data['date']; ?></div>
    <div class="space-delete"></div>
                                                     
                                                     <form action='../inc/delete_entry.php' method='post'>
                                                     <?php
        echo '<td>
                                                             <button type="submit" name="deletecommande" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                     </td>';
    ?>
                                                </form>
  </div>
