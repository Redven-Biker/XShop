...
if (isset($_SESSION['id'])) {
    ...
    <body id="page-top">
        ...
        <h1 class="masthead-heading text-uppercase mb-0">Products</h1>
...
?>
  <tr>
    ...
    <td><a id="color-text" href="<?php echo $data['img']; ?>" target="_blank">Lien</a></td>
    ...
    <td><?php echo $data['date']; ?></td>
                                                     ...
                                                     <?php
        echo '<td>
                                                             <button type="submit" name="deleteproduit" class="btn btn-danger w-100 py-1" value="' . $data['id'] . '">Delete</button>
                                                     </td>';
    ?>
                                                </form>
  </tr>
