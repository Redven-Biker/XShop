...
if (isset($_SESSION['id'])) {
    ...
    <body id="page-top">
        ...
        <h1 class="masthead-heading text-uppercase mb-0">Category</h1>
...
?>
  <tr>
    <td><?php echo $data['nom']; ?></td>
                                                     ...
                                                     <?php
        echo '<td>
                                                             <center><button type="submit" name="deletecategorie" class="btn btn-danger py-1" value="' . $data['id'] . '">Delete</button></center>
                                                     </td>';
    ?>
  </tr>
                                                <?php
