...
?>
        <title><?php echo $data['nom']; ?> - Admin Panel</title>
...
if (isset($_SESSION['id'])) {
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1 dropdown">
                            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Category</a>
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="voir-categories.php">See the category</a>
                              <a class="dropdown-item" href="ajouter-categorie.php">Add a category</a>
                            </div>
                        </li>
                        <li class="nav-item mx-0 mx-lg-1 dropdown">
                            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Products</a>
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="voir-produits.php">See the product</a>
                              <a class="dropdown-item" href="ajouter-produit.php">Add a product</a>
                            </div>
                        </li>
                        <li class="nav-item mx-0 mx-lg-1 dropdown">
                            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Order</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="voir-commandes.php">See the order</a>
                            </div>
                        </li>
  ...
  <a href="voir-produits.php"><img class="img" src="assets/img/index/voir-produit.jpg" width="25%"></a>
  <a href="ajouter-produit.php"><img class="img" src="assets/img/index/ajouter-produit.jpg" width="25%"></a>
  <a href="voir-commandes.php"><img class="img" src="assets/img/index/voir-commandes.jpg" width="25%"></a>
  <br>
  <div class="space-grid"></div>
  <a href="voir-categories.php"><img class="img" src="assets/img/index/voir-categories.jpg" width="25%"></a>
  <a href="ajouter-categorie.php"><img class="img" src="assets/img/index/ajouter-categorie.jpg" width="25%"></a>
  <div class="space"></div>
        </header>
        ';
      include("../inc/config.php");
