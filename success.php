...
<link rel='stylesheet' id='isotope-css'  href='wp-content/themes/css/success.css' type='text/css' media='all' />
...
<li id="nav-menu-item-422" class="page-scroll main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom"><a class="menu-link main-menu-link" href="boutique.php">Shop</a></li>
                ...
                <section class="section normal center" style="background-color:#232323; ">
                    <div class="container ">
...
<div class="Message Message--green">
  ...
  <div class="Message-body">
    <p class="text-dark"><b>We have received your request.</b></p>
    <p class="text-dark"><b>We will contact you within 24 hours on Discord to confirm receipt of your product.</b></p>
    <p class="text-dark"><b>For any questions, join the discord.</b></p>
  <?php include("inc/config.php");
  $reponse = $bdd->query('SELECT * FROM config');
  while ($data = $reponse->fetch()) { ?> 
      <a href="<?php echo $data['discord_serveur']; ?>" target="_blank"><button class="btn">Join Discord</button></a>
<?php } $reponse->closeCursor(); // Complete query ?>
  </div>
</div>
