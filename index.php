...
<link rel='stylesheet' id='isotope-css'  href='wp-content/themes/css/index.css' type='text/css' media='all' />
...
<li id="nav-menu-item-422" class="page-scroll main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom"><a class="menu-link main-menu-link" href="boutique.php">Shop</a></li>
            ...
            <section id="home-slider" class="tiny">
                <div id="owl-main" class="owl-carousel">
                                                                <div class="item"><img src="wp-content/uploads/sites/2/2015/04/slide2.jpg" alt=""></div>
                                            <div class="item"><img src="wp-content/uploads/sites/2/2015/04/slide.jpg" alt=""></div>
                                    </div>
                <div class="slide-content">
                                        <div id="owl-main-text" class="owl-carousel">
                                                    <div class="item"><h2>Text 1</h2></div>
                                                    <div class="item"><h2>Text 2</h2></div>
                                            </div>
                ...
                <section id="about-us" class="section about-us " style="background-color:#232323; background-image: url(wp-content/uploads/sites/2/2015/07/background_171.jpg)">
                    <div class="container full-width"><br><br><br>  
                        <div class="row jt_row jt_row-fluid"><div class="vertical-center jt_col col-sm-12 col-lg-6 col-md-6 col-xs-12"><div class="vc_column-inner "><div class="wpb_wrapper"><h2 class="title deco">About us</h2><div class="about-us__content"></p>
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ligula metus, laoreet non tincidunt id, tristique non nunc. Quisque quis erat accumsan, efficitur est eu, fermentum odio. Sed vel nunc a nunc convallis pharetra et vel eros. Integer est mi, gravida et elementum a, vulputate dapibus lectus. Maecenas semper enim id finibus consectetur. Cras congue lorem sed viverra auctor. In vel nisi in ligula ultrices pulvinar. Etiam pulvinar cursus tempus. Cras ultricies sed nunc sed luctus. Etiam porta sed massa ac mattis. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut nec vestibulum felis. In rutrum ex ac tellus pellentesque suscipit. Nulla orci nunc, vulputate maximus mauris in, consequat malesuada felis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
<p>
</div></div></div></div><div class="jt_col col-sm-12 col-lg-6 col-md-6 col-xs-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="carousel-wrapper full with_pagination round_inner with_buttons ">
        <div class="owl-carousel generic-carousel"><div class="item"><img width="959" height="720" src="wp-content/uploads/sites/2/2015/07/slide-about_03.png" class="attachment-full size-full" alt="" srcset="wp-content/uploads/sites/2/2015/07/slide-about_03.png 959w" sizes="(max-width: 959px) 100vw, 959px" /></div></div>
    </div></div></div></div></div>
    <br><br><br>
                    </div>
                </section>
                ...
                <section id="video" class="section video center" style="background-color:#fff; background-image: url(wp-content/uploads/sites/2/2015/04/slide2.jpg)">
                    <div class="container ">
                        <div class="row jt_row jt_row-fluid"><div class="jt_col col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="voffset40"></div><h2 class="title ">DESCRIPTION 1</h2><div class="voffset40"></div></div></div></div></div>
